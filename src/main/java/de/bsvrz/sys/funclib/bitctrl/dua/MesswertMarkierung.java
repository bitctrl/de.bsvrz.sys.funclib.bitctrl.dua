...
public class MesswertMarkierung implements Cloneable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = (prime * result) + (formalMax ? 1231 : 1237);
		result = (prime * result) + (formalMin ? 1231 : 1237);
		result = (prime * result) + (implausibel ? 1231 : 1237);
		result = (prime * result) + (interpoliert ? 1231 : 1237);
		result = (prime * result) + (logischMax ? 1231 : 1237);
		result = (prime * result) + (logischMin ? 1231 : 1237);
		result = (prime * result) + (nichtErfasst ? 1231 : 1237);
		result = (prime * result) + (veraendert ? 1231 : 1237);
		return result;
	}
